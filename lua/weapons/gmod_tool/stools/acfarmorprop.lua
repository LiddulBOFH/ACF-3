...
local function UpdateValues(Entity, Data, PhysObj, Area, Ductility)
	...
	Entity.ACF.OldArmor	 = (not Entity.IsACFEntity) or false
...
if CLIENT then
	...
	function TOOL.BuildCPanel(Panel) -- TODO: Make a line of text change depending on settings
		...
		local DensitySlider = Panel:NumSlider("Density", "acfarmorprop_density", 0.01, 50)
		DensitySlider:SetValue(7.84) -- default to RHA
...
function TOOL:LeftClick(Trace)
	...
	if Ent.ACF.OldArmor then
		Ent.ACF.OldArmor = nil
		duplicator.ClearEntityModifier(Ent,"ACF_Armor")
