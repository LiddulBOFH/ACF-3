...
function ACF.Activate(Entity, Recalc)
	...
	-- TODO: Enable old armor system to still be usable but not able to be applied anymore, for compatibility with old dupes (give worse health)
	...
	if (Entity._Mesh or PhysObj:GetMesh()) and (Entity.ACF.Type == "Prop") and (not Entity.IsACFEntity) and not Entity.ACF.OldArmor then
